...
from han_usv_controller.buoy_course import COLREGS_LEARNING_BUOYS
...
def generate_launch_description():
    ...
    model_file = os.path.join(
        share, 'models', 'than_arget_vessel', 'model.sdf')
    buoy_model_files = {
        'red': os.path.join(
            share, 'models', 'han_marker_buoy_red', 'model.sdf'),
        'green': os.path.join(
            share, 'models', 'han_marker_buoy_green', 'model.sdf'),
    }
    forwarded = {
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('target_name', default_value='than_arget_vessel'),
        ...
        DeclareLaunchArgument(
            'target_2_name', default_value='than_arget_vessel_southbound'),
