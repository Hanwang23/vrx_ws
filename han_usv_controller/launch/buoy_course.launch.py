...
from han_usv_controller.buoy_course import BUOY_SPECS
...
def generate_launch_description():
    controller_share = get_package_share_directory('han_usv_controller')
    simulation_launch = os.path.join(
        controller_share, 'launch', 'simulation.launch.py')
    model_files = {
        'red': os.path.join(
            controller_share, 'models', 'han_marker_buoy_red', 'model.sdf'),
        'green': os.path.join(
            controller_share, 'models', 'han_marker_buoy_green', 'model.sdf'),
        'orange': os.path.join(
            controller_share, 'models', 'han_round_buoy_orange', 'model.sdf'),
    }
