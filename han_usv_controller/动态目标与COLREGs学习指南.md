...
看到 `Finished <<< han_usv_controller` 表示构建完成。
...
这里的位置是 `han_usv_odom` 局部 ENU 坐标，不是 Gazebo 世界绝对坐标。
...
本次已验证基线位于 `han_usv_controller/evaluation/20260717T002427Z/aggregate.json`：
