...
from han_usv_controller.dynamic_map import mask_dynamic_scan_ranges
from han_usv_controller.moving_target import target_pose
...
class DynamicLearningTests(unittest.TestCase):
    ...
    def test_dynamic_vessel_is_large_enough_for_visual_learning(self):
        ...
        model = ET.parse(
            root / 'models' / 'than_arget_vessel' / 'model.sdf').getroot()
        size = model.findtext(
