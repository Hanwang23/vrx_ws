...
from han_usv_controller.evaluation import (
    EvaluationThresholds,
    aggregate_trials,
    analyze_trial,
    parse_summary_lines,
)
from han_usv_controller.evaluation_runner import (
...
class EvaluationTests(unittest.TestCase):
    def test_stale_cleanup_covers_every_long_running_Han_process(self):
    ...
    def test_process_matching_ignores_runner_ancestry(self):
        matches = _matching_processes([
            '10 ros2 run han_usv_controller run_evaluation',
