...
STALE_PROCESS_PATTERNS = (
    ...
    'install/lib/codex_usv_controller/run_evaluation',
    'install/lib/codex_usv_controller/regression_monitor',
    'install/lib/codex_usv_controller/autonomous_usv',
    'install/lib/codex_usv_controller/moving_target',
    'install/lib/codex_usv_controller/gnss_odometry_adapter',
...
def _run_trial(
    ...
    launch_command = [
        'ros2', 'launch', 'codex_usv_controller', launch_file,
    ...
    monitor_command = [
        'ros2', 'run', 'codex_usv_controller', 'regression_monitor',
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument('--output-root', default='codex_fix/evaluation')
